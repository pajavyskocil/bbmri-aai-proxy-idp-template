...
if (!$warningIsOn || $warningUserCanContinue) {
    ...
    if ($this->isAddInstitutionApp()) {
	    ...
	    echo '<a class="btn btn-block social" href="https://aai-test.bbmri-eric.eu/non/registrar/?vo=lifescience_hostel&targetnew=https://aai-test.bbmri-eric.eu/non/registrar/?vo=bbmri&targetexisting=https://aai-test.bbmri-eric.eu/non/registrar/?vo=bbmri&targetextended=https://aai-test.bbmri-eric.eu/non/registrar/?vo=bbmri" style="background: #95CC67">';
