...
$this->data['head'] .= '<script src="' . SimpleSAML\Module::getModuleUrl('bbmri-eric/res/js/jquery.js')  . '" ></script>';
$this->data['head'] .= '<script src="' . SimpleSAML\Module::getModuleUrl('bbmri-eric/res/bootstrap/js/bootstrap.min.js')  . '" ></script>';
