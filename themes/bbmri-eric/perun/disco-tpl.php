...
if ($this->isOriginalSpNonFilteringIdPs()) {
	...
	echo $this->t('{bbmri:bbmri:cannot_find_institution_extended}') . '<a class="btn btn-primary" href="https://perun.bbmri-eric.eu/add-institution/">' . $this->t('{bbmri:bbmri:add_institution}') . '</a>';
}
echo '</div>';
